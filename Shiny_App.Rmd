...
survey_questions <- data.frame(var = c("Age", "Gender", "Country", "state", 
                               ...
                               question = c(NA, NA, NA, NA, "Are you self-employed?", 
  ...
  navbarPage(
    ...
    tabPanel("USA Map",
             sidebarPanel(
              ...
              selectInput("map_variable", "Select variable:", choices = unique(names(clean_data)[2:ncol(clean_data)])),
          ),
          mainPanel(
          leafletOutput("map"))
      )       
    ...
    if(input$plot == "bar graph"){
      ...
      ggplot(clean_data_summary(), aes(x = reorder(!!sym(input$variable), -Percentage), 
        ...
        geom_point(color = "navy",
                   size = 6) + 
        labs(x = input$variable, main = str_c("Percentages of ", 
                                              input$gender, 
                                              input$variable))
    }
  })
